...
public class  TwitterClient extends OAuthBaseClient {
	...
	public void getHomeTimeline (JsonHttpResponseHandler handler) {
		String apiUrl = getApiUrl("statuses/home_timeline.json"); // need to insert the correct path here instead of flicker, go back to the video with API keys creation
